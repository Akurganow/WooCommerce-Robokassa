...
# main config
PLUGINSLUG="robokassa-for-woocommerce"
CURRENTDIR=`pwd`
MAINFILE="wc-robokassa.php" # this should be the name of your main php file in the wordpress plugin
...
SVNUSER="akurganow" # your svn username
